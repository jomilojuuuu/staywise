      ...
      <div className="text-white font-bold pt-5">
        <div className="flex justify-between items-center px-4 md:px-4">
          ...
          <div className="w-[520px] hidden lg:flex gap-2 justify-between items-center">
            ...
            <h1 className="p-3 hover:bg-[#2551837e] cursor-pointer hover:rounded">
              List your property
            </h1>
            <Link
              href="/signup"
              className="cursor-pointer p-2 rounded bg-white text-blue-500 hover:bg-gray-50"
            >
              Register
            </Link>
            <Link
